    ...
    <div>
        <div class="rtl wrapper fixed-top">
            <nav class="navbar navbar-expand-md navbar-dark custom-navbar">
                ...
                <!--</button>-->
                <a class="navbar-brand img-fluid" href="#"><img class="brand" src="assets/img/logo.pn'" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <router-link id="testt" :to="{name:'games'}" class="nav-link active">بازی ها
                ...
                <form @keydown.enter.prevent="" class="d-none form-navbar form-inline my-2 my-lg-0 position-relative">
                    <span class="fa fa-search fa-search-placeholder"></span>
                    <input v-model="searchedText"
                           class="form-control mr-sm-2 custom-search-input" type="search" placeholder="جستجو..."
                           aria-label="Search">
                </form>
                <div class="nav navbar-nav ml-auto navbar-left ">
                    ...
                    <li v-if="user" class="nav-item dropdown nav-link position-absolute">
                        <i  class="dropdown-toggle ml-2 mb-3 fa fa-user text-white"  id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ></i>

                        <div class="dropdown-menu bg-dark text-white " aria-labelledby="navbarDropdown">
                            <router-link  :to="{name:'home'}" class="ml-1 mt-1 text-white d-block">{{user.full_name}}</router-link>
                            <a @click.prevent="logout" class="ml-1 mt-1 text-white d-block">خروج</a>
                        </div>
                    </li>
                </div>
                <search-result v-if="!isShowSmSearchInput" :searchString="searchedText" top="50px" left="75px"width="50vw"></search-result>
            ...
            <div v-if="isShowSmSearchInput">
                <form @keydown.enter.prevent=""
                    ...
                    <i class="close-sm-search fa fa-times" @click="isShowSmSearchInput =!isShowSmSearchInput"
                        fixed-width></i>
                </form>
